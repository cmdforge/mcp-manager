...
```ts
import { protocol } from "@cmdforge/mcp-manager";
...
```ts
import { createClient } from "@cmdforge/mcp-manager/client";
import { protocol } from "@cmdforge/mcp-manager";
...
```ts
import { createServer } from "@cmdforge/mcp-manager/server";
import { protocol } from "@cmdforge/mcp-manager";
...
```sh
npx -y @cmdforge/mcp-manager manage
```
